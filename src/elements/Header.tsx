...
const Header = () => {
  return (
    <section className="relative flex flex-col  justify-center items-center bg-Blue lg:pt-0 pt-10">
      <h1 className="font-Headingfront absolute lg:top-24 top-8 leading-10 text-3xl w-96 lg:w-full text-center lg:text-5xl text-White font-extrabold tracking-widest">WE ARE CREATIVES</h1>

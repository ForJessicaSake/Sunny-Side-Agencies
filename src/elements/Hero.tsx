...
const Hero = () => {
  return (
    <div>
      <section id="about" className="w-full flex flex-col lg:flex-row lg:flex-row-reverse items-center justify-center lg:text-start text-center lg:flex-row lg:justify-between">
        ...
        <figcaption className=" w-6/12 flex flex-col lg:pl-16 lg:justify-start lg:items-start justify-center items-center">
          <h1 className="font-Headingfront text-Heading pt-14 text-4xl lg:w-80 leading-snug w-80 font-extrabold pb-7">Transform your brand</h1>
      ...
      <figure className=" lg:w-6/12 w-full ">
        ...
        <figcaption className=" w-6/12 flex flex-col lg:pl-16 lg:justify-start lg:items-start justify-center items-center">
          <h1 className="font-Headingfront text-Heading pt-14 text-4xl lg:w-96 w-80 leading-snug font-extrabold pb-7">Stand out to the right audience</h1>
